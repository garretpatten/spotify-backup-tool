...
describe('FileManager', () => {
  ...
  describe('sanitizeFileName', () => {
    it('should sanitize special characters', () => {
      expect(fileManager.sanitizeFileName('My/Playlist: "Test"')).toBe('My_Playlist___Test_');
    });
  ...
  describe('ensureBackupDirectory', () => {
    it('should create backup directories', async () => {
      ...
      expect(fs.ensureDir).toHaveBeenCalledWith(path.join(fileManager.backupDir, 'public'));
      expect(fs.ensureDir).toHaveBeenCalledWith(path.join(fileManager.backupDir, 'private'));
    });
    ...
    it('should handle directory creation errors', async () => {
      ...
      await expect(fileManager.ensureBackupDirectory()).rejects.toThrow('Permission denied');
    });
  });
  ...
  describe('savePlaylist', () => {
    ...
    it('should handle save errors', async () => {
      ...
      await expect(fileManager.savePlaylist(playlistData)).rejects.toThrow('Write failed');
    });
  });
  ...
  describe('createZipArchive', () => {
    it('should create zip archive successfully', async () => {
      ...
      expect(mockArchiver.directory).toHaveBeenCalledWith(fileManager.backupDir, 'spotify-playlists');
    ...
    it('should handle archive errors', async () => {
      ...
      await expect(fileManager.createZipArchive()).rejects.toThrow('Archive error');
    });
  });
  ...
  describe('getBackupStats', () => {
    it('should calculate backup statistics', async () => {
      ...
      jest.spyOn(fileManager, 'getAllPlaylistFiles').mockResolvedValue([
